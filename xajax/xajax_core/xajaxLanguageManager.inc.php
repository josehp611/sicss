<?php
/*
 * File: xajaxLanguageManager.inc.php Contains the code that manages the
 * inclusion of alternate language support files; so debug and error messages
 * can be shown in a language other than the default (english) language. Title:
 * xajaxLanguageManager class Please see <copyright.inc.php> for a detailed
...
class xajaxLanguageManager {
	...
	/*
	 * Function: xajaxLanguageManager Construct and initialize the one and only
	 * xajax language manager object.
	 */
	...
	/*
	 * Function: getInstance Implements the singleton pattern: provides a single
	 * instance of the xajax language manager object to all object which request
	 * it.
	 */
	...
	/*
	 * Function: configure Called by the main xajax object as configuration
	 * options are set. See also: <xajax::configure>. The <xajaxLanguageManager>
	 * tracks the following configuration options. Parameters: - language
	 * (string, default 'en'): The currently selected language.
	 */
	...
	/*
	 * Function: register Called to register an array of alternate language
	 * messages. Parameters: sLanguage - (string): the character code which
	 * represents the language being registered. aMessages - (array): the array
	 * of translated debug and error messages
	 */
	...
	/*
	 * Function: getText Called by the main xajax object and other objects
	 * during the initial page generation or request processing phase to obtain
	 * language specific debug and error messages. sMessage - (string): A code
	 * indicating the message text being requested.
	 */
