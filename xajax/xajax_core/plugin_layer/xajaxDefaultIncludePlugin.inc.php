<?php
/*
 * File: xajaxDefaultIncludePlugin.inc.php Contains the default script include
 * plugin class. Title: xajax default script include plugin class Please see
 * <copyright.inc.php> for a detailed description, copyright and license
 * information.
 */
...
class xajaxIncludeClientScriptPlugin extends xajaxRequestPlugin {
	...
	function configure($sName, $mValue) {
		if ('javascript URI' == $sName) {
			...
			if ("POST" == $mValue || "GET" == $mValue) // W3C: Method is case
			                                           // sensitive
	...
	/*
	 * Function: getJavascriptConfig Generates the xajax settings that will be
	 * used by the xajax javascript library when making requests back to the
	 * server. Returns: string - The javascript code necessary to configure the
	...
	/*
	 * Function: printJavascriptConfig See
	 * <xajaxIncludeClientScriptPlugin::getJavascriptConfig>
	 */
	...
	/*
	 * Function: getJavascriptInclude Generates SCRIPT tags necessary to load
	 * the javascript libraries on the browser. sJsURI - (string): The relative
	 * or fully qualified PATH that will be used to compose the URI to the
	 * specified javascript files. aJsFiles - (array): List of javascript files
	 * to include. Returns: string - The SCRIPT tags that will cause the browser
	 * to load the specified files.
	 */
	...
	/*
	 * Function: printJavascriptInclude See
	 * <xajaxIncludeClientScriptPlugin::getJavascriptInclude>
	 */
	...
	/*
	 * Function: _getScriptFilename Returns the name of the script file, based
	 * on the current settings. sFilename - (string): The base filename.
	 * Returns: string - The filename as it should be specified in the script
	 * tags on the browser.
	 */
...
/*
 * Register the xajaxIncludeClientScriptPlugin object with the
 * xajaxPluginManager.
 */
