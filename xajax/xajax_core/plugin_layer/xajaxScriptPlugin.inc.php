<?php
/*
 * File: xajaxScriptPlugin.inc.php Contains the xajaxScriptPlugin class
 * declaration. Title: xajaxScriptPlugin class Please see <copyright.inc.php>
 * for a detailed description, copyright and license information.
 */
...
class xajaxScriptPlugin extends xajaxRequestPlugin {
	...
	/*
	 * Function: xajaxScriptPlugin Construct and initialize the xajax script
	 * plugin object. During initialization, this plugin will look for hash
	 * codes in the GET data (parameters passed on the request URI) and store
	 * them for later use.
	 */
	 ...
	 * plugin. See also: <xajax::configure>. This plugin will watch for and
	 * store the current setting for the following configuration options: -
	 * <requestURI> (string): The requestURI of the current script file. -
	 * <deferScriptGeneration> (boolean): A flag that indicates whether script
	 * deferral is in effect or not. - <deferScriptValidateHash> (boolean): A
	 * flag that indicates whether or not the script hash should be validated.
	 */
	...
	/*
	 * Function: generateClientScript Called by the <xajaxPluginManager> when
	 * the text of the client script (or style) declarations are needed. This
	 * function will only output script or style information if the request URI
	 * contained an appropriate hash code and script deferral is in effect.
	 */
	...
	/*
	 * Function: canProcessRequest Called by the <xajaxPluginManager> to
	 * determine if this plugin can process the current request. This will
	 * return true when the requestURI contains an appropriate hash code.
	 */
	...
	/*
	 * Function: processRequest Called by the <xajaxPluginManager> when the
	 * current request should be processed. This plugin will generate the
	 * javascript or style sheet information that would normally be output by
	 * the other xajax plugin objects, when script deferral is in effect. If
	 * script deferral is disabled, this function returns without performing any
	 * functions.
	 */
