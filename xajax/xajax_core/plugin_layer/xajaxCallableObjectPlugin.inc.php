<?php
/*
 * File: xajaxCallableObjectPlugin.inc.php Contains the
 * xajaxCallableObjectPlugin class Title: xajaxCallableObjectPlugin class Please
 * see <copyright.inc.php> for a detailed description, copyright and license
 * information.
 */
