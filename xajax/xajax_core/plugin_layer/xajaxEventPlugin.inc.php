<?php
/*
 * File: xajaxEventPlugin.inc.php Contains the xajaxEventPlugin class Title:
 * xajaxEventPlugin class Please see <copyright.inc.php> for a detailed
...
/*
 * Class: xajaxEventPlugin Plugin that adds server side event handling
 * capabilities to xajax. Events can be registered, then event handlers
 * attached.
 */
class xajaxEventPlugin extends xajaxRequestPlugin {
	...
	/*
	 * Function: register $sType - (string): type of item being registered
	 * $sEvent - (string): the name of the event $ufHandler - (function name or
	 * reference): a reference to the user function to call $aConfiguration -
