<?php
/*
 * File: xajax_lang_nl.inc.php Contains the debug and error messages output by
 * xajax translated to Dutch. Title: xajax class Please see <copyright.inc.php>
 * for a detailed description, copyright and license information. Translations
 * provided by: (Thank you!) - Jeffrey <walkingsoul@gmail.com>
 */
