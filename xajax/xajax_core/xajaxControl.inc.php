<?php
/*
 * File: xajaxControl.inc.php Contains the base class for all controls. Title:
 * xajaxControl class Please see <copyright.inc.php> for a detailed description,
...
if (false == defined ( 'XAJAX_HTML_CONTROL_DOCTYPE_VALIDATION' ))
	...
	/*
 * Class: xajaxControl The base class for all xajax enabled controls. Derived
 * classes will generate the HTML and javascript code that will be sent to the
 * browser via <xajaxControl->printHTML> or sent to the browser in a
 * <xajaxResponse> via <xajaxControl->getHTML>.
 */
class xajaxControl {
	/*
	 * String: sTag
	...
	/*
	 * Boolean: sEndTag 'required' - (default) Indicates the control must have a
	 * full end tag 'optional' - The control may have an abbr. begin tag or a
	 * full end tag 'forbidden' - The control must have an abbr. begin tag and
	 * no end tag
	 */
	var $sEndTag;
	
	/*
	 * Array: aAttributes An associative array of attributes that will be used
	 * in the generation of the HMTL code for this control.
	 */
	var $aAttributes;
	
	/*
	 * Array: aEvents An associative array of events that will be assigned to
	 * this control. Each event declaration will include a reference to a
	 * <xajaxRequest> object; it's script will be extracted using
	 * <xajaxRequest->printScript> or <xajaxRequest->getScript>.
	 */
	var $aEvents;
	
	/*
	 * String: sClass Contains a declaration of the class of this control.
	 * %inline controls do not need to be indented, %block controls should be
	 * indented.
	 */
	var $sClass;
	
	/*
	 * Function: xajaxControl Parameters: $aConfiguration - (array): An
	 * associative array that contains a variety of configuration options for
	 * this <xajaxControl> object. Note: This array may contain the following
	 * entries: 'attributes' - (array): An associative array containing
	 * attributes that will be passed to the <xajaxControl->setAttribute>
	 * function. 'children' - (array): An array of <xajaxControl> derived
	 * objects that will be the children of this control.
	 */
	...
	/*
	 * Function: clearAttributes Removes all attributes assigned to this
	 * control.
	 */
	...
	/*
	 * Function: setAttribute Call to set various control specific attributes to
	 * be included in the HTML script that is returned when
	 * <xajaxControl->printHTML> or <xajaxControl->getHTML> is called.
	 * Parameters: $sName - (string): The attribute name to set the value.
	...
	/*
	 * Function: getAttribute Call to obtain the value currently associated with
	 * the specified attribute if set. Parameters: sName - (string): The name of
	 * the attribute to be returned. Returns: mixed : The value associated with
	...
	/*
	 * Function: clearEvents Clear the events that have been associated with
	 * this object.
	 */
	...
	/*
	 * Function: setEvent Call this function to assign a <xajaxRequest> object
	 * as the handler for the specific DOM event. The
	 * <xajaxRequest->printScript> function will be called to generate the
	 * javascript for this request. Parameters: sEvent - (string): A string
	 * containing the name of the event to be assigned. objRequest -
	 * (xajaxRequest object): The <xajaxRequest> object to be associated with
	 * the specified event. aParameters - (array, optional): An array containing
	 * parameter declarations that will be passed to this <xajaxRequest> object
	 * just before the javascript is generated. sBeforeRequest - (string,
	 * optional): a string containing a snippet of javascript code to execute
	 * prior to calling the xajaxRequest function sAfterRequest - (string,
	 * optional): a string containing a snippet of javascript code to execute
	 * after calling the xajaxRequest function
	 */
	...
	/*
	 * Function: getHTML Generates and returns the HTML representation of this
	 * control and it's children. Returns: string : The HTML representation of
	 * this control.
	 */
	...
	/*
	 * Function: printHTML Generates and prints the HTML representation of this
	 * control and it's children. Returns: string : The HTML representation of
	 * this control.
	 */
	function printHTML($sIndent = '') {
		...
		if ('forbidden' == $this->sEndTag) {
			...
			if ('%inline' != $sClass)
				// this odd syntax is necessary to detect request for no
				// formatting
				if (false === (false === $sIndent))
					echo "\n";
	...
	function _printAttributes() {
		// NOTE: Special case here: disabled='false' does not work in HTML; does
		// work in javascript
...
/*
 * Class: xajaxControlContainer This class is used as the base class for
 * controls that will contain other child controls.
 */
class xajaxControlContainer extends xajaxControl {
	...
	/*
	 * Boolean: sChildClass Will contain '%inline' if all children are class =
	 * '%inline', '%block' if all children are '%block' or '%flow' if both
	 * '%inline' and '%block' elements are detected.
	 */
	var $sChildClass;
	
	/*
	 * Function: xajaxControlContainer Called to construct and configure this
	 * control. Parameters: aConfiguration - (array): See
	 * <xajaxControl->xajaxControl> for more information.
	 */
	...
	/*
	 * Function: getContentClass Returns the *adjusted* class of the content
	...
	/*
	 * Function: clearChildren Clears the list of child controls associated with
	 * this control.
	 */
	...
	/*
	 * Function: addChild Adds a control to the array of child controls. Child
	 * controls must be derived from <xajaxControl>.
	 */
