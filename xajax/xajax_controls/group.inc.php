<?php
/*
 * File: group.inc.php HTML Control Library - Group Level Tags Title: xajax HTML
...
/*
 * Class: clsTable A <xajaxControlContainer> derived class that aids in the
 * construction of HTML tables. Inherently, <xajaxControl> and
 * <xajaxControlContainer> derived classes support <xajaxRequest> based events
 * using the <xajaxControl->setEvent> method.
 */
class clsTable extends xajaxControlContainer {
	...
	/*
	 * Function: clsTable Constructs and initializes an instance of the class.
	 */
...
class clsThead extends clsTableRowContainer {
	/*
	 * Function: clsThead Constructs and initializes an instance of the class.
	 */
...
class clsTbody extends clsTableRowContainer {
	/*
	 * Function: clsTbody Constructs and initializes an instance of the class.
	 */
...
class clsTfoot extends clsTableRowContainer {
	/*
	 * Function: clsTfoot Constructs and initializes an instance of the class.
	 */
...
class clsTr extends xajaxControlContainer {
	...
	/*
	 * Function: clsTr Constructs and initializes an instance of the class.
	 */
...
class clsTd extends xajaxControlContainer {
	/*
	 * Function: clsTd Constructs and initializes an instance of the class.
	 */
...
class clsTh extends xajaxControlContainer {
	/*
	 * Function: clsTh Constructs and initializes an instance of the class.
	 */
