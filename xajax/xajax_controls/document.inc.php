<?php
/*
 * File: document.inc.php HTML Control Library - Document Level Tags Title:
 * xajax HTML control class library Please see <copyright.inc.php> for a
...
class clsTitle extends xajaxControlContainer {
	...
	function setEvent($sEvent, &$objRequest) {
		trigger_error ( 'clsTitle objects do not support events.' . $this->backtrace (), E_USER_ERROR );
	}
}
