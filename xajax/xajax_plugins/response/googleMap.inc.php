<?php
/*
 * File: googleMap.inc.php Contains a class that can be used to invoke DOM calls
 * on the browser which will create or update a google map. Title: clsGoogleMap
...
class clsGoogleMap extends xajaxResponsePlugin {
	...
	/*
	 * String: sGoogleSiteKey The key that google has assigned to your site. Set
	 * this with <clsGoogleMap->setKey>
	 */
