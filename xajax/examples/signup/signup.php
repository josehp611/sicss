<?php
/*
 * File: signup.php Example which demonstrates a xajax implementation of a
 * multi-page sign-up. Title: Multi-page Sign-up Example Please see
...
<body>
	<div id="formWrapper">
		...
		<div id="formDiv">
			<form id="signupForm" action="javascript:void(null);"
