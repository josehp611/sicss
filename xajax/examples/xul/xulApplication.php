<?php
/*
 * File: xulApplication.php Example which demonstrates a XUL application with
 * xajax. XUL will only work in Mozilla based browsers like Firefox. Title: XUL
 * Example - Application Please see <copyright.inc.php> for a detailed
