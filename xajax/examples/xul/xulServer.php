<?php
/*
 * File: xulServer.php Example which demonstrates a XUL application with xajax.
 * XUL will only work in Mozilla based browsers like Firefox. Title: XUL Example
 * - Server Please see <copyright.inc.php> for a detailed description, copyright
...
/*
 * Function: test alert 'hallo', then update the testButton's label to 'Success'
 */
function test() {
