...
(e.match(t)||(e="on"+e),a=document.createEventObject(g),this.fireEvent(e,a))};d.pnotify.defaults={title:false,title_escape:false,text:false,text_escape:false,styling:"bootstrap",addclass:"",cornerclass:"ui-corner-all",nonblock:true,nonblock_opacity:0.4,history:false,width:"300px",min_height:"16px",type:"notice",icon:true,animation:"none",animate_speed:"fast",opacity:1,shadow:true,closer:true,closer_hover:true,sticker:true,sticker_hover:true,hide:true,delay:5000,mouse_reset:false,remove:true,insert_brs:true,stack:{dir1:"down",
