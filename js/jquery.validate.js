...
(function($) {  
	...
	$.validator.messages = ({    
		...
		remote: 'necesita verificacion',    
		email: 'correo no valido',    
		url: 'direccion no valida',    
		date: 'fecha no valida',    
		dateISO: 'fecha no valida (ISO)',    
		number: 'numero no valido',    
		digits: 'debe ser digito',    
		creditcard: 'is not a valid credit card number',    
		equalTo: 'debe ser el mismo valor',    
		accept: 'is not a value with a valid extension',    
		maxlength: jQuery.validator.format('no debe tenera mas de {0} caracteres'),    
		minlength: jQuery.validator.format('debe tener como minimo {0} caracteres'),    
		rangelength: jQuery.validator.format('debe ingresar un valor entre {0} y {1} caracteres'),    
		range: jQuery.validator.format('un valor entre {0} y {1}'),    
		max: jQuery.validator.format('valor mayo a {0}'),    
		min: jQuery.validator.format('valor menor a {0}')  
	});  
