	...
	<tbody>
		...
		<tr class="tsol <?php echo $sol->tipo?> <?php echo $color?>">
			...
			<td>
                ...
                <u><i class="glyphicon glyphicon-user"></i> <?php echo $sol->usuario?></u>
                <br/>
            ...
            <td>
                <?php if($sol->estado=='1' || $sol->estado=='N2-R'):?>
