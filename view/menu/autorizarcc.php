...
<table class="table tbl-kpi">
	<thead>
		<tr>
			<th style="width: 55px">No. <br/>Solicitud</th>
			<th style="width: 210px">Cco.</th>
			<th style="width: 320px">Descrición</th>
			<th style="width: 155px;">Estado</th>
			<th style="width: 80px;">Fecha<br>Hora</th>
		...
		<tr class="tsol <?php echo $sol->tipo?> <?php echo $color?>">
			...
			<td>
				<b style='min-width:160px;display:inline-block;'>
                    ...
                    <?php endif?>
                </b> &nbsp; <u><i class="glyphicon glyphicon-user"></i> <?php echo $sol->usuario?></u>
                <br/>
