...
<h4 class="text-blue">Reporte de Solicitudes de Compra</h4>
    ...
    $(document).ready(function(){
        ...
        $('form').submit(function(e){
            ...
            if(formulario.isValid()){
                window.open("http://192.168.40.4/report/solicitud_sc.ashx?id_empresa=" + formulario.id_empresa() + "&fecha_inicial=" + formulario.fecha1 + "&fecha_final=" + formulario.fecha2 + "&tipo=" + formulario.tipo() + '&empresa=' + formulario.nombre_empresa(), '_blank');
            }
            return false;
        });
        var formulario = {
