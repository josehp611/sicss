...
<h4 class="text-blue">Reporte de Solicitud de Compra por Fecha Creación</h4>
...
<div class="row">
	...
	<div class="col-sm-5">
		<select class="form-control" id="tipo" name="tipo">
            ...
            <option value="orden">En Orden de Compra</option>
        </select>
	</div>
</div>
<br/>
    ...
    $(document).ready(function(){
        ...
        $('form').submit(function(e){
            ...
            if(formulario.isValid()){
                window.open("http://192.168.40.4/report/solicitud_so2.ashx?id_empresa=" + formulario.id_empresa() + "&fecha_inicial=" + formulario.fecha1 + "&fecha_final=" + formulario.fecha2 + "&tipo=" + formulario.tipo() + '&empresa=' + formulario.nombre_empresa(), '_blank');
            }
            return false;
        });
        var formulario = {
