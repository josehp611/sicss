...
<div class="container-fluid">
	<div class="row">
		<h3>Mantenimiento de usuarios autorizadores </h3>
		<p>Usuarios con acceso para autorizacion de solicitudes de compra por categoria.</p>
		<div class="col-md-12">
			<div class="panel panel-default panel-table">
				<div class="panel-heading">
                	<div class="row">
                  		<div class="col col-xs-6">
                    		<h3 class="panel-title">Listado de usuarios autorizadores por categoria</h3>
                  		</div>
				...
				<div class="panel-body">
					<table id="gestoresTabla" name="gestoresTabla" class="table table-striped table-bordered table-list">
						...
						<tbody>
								...
								<tr>
									<td align="center"> 
										<a href="?c=solc&a=ges2&id=4&usr=<?php echo $gestor['id_auto_categoria']; ?>&del" class="btn btn-danger"><em class="fa fa-trash"></em></a>
									</td>
									<td><?php echo $gestor['usr_usuario']; ?></td>
									<td><?php echo $gestor['usr_nombre']; ?></td>
									<td><?php echo $gestor['nombre_categoria']; ?></td>
									<td><?php echo $niveles[$gestor['gestion_nivel']]; ?></td>
								</tr>
								<?php } }?>
						</tbody>
					</table>
...
<div class="modal fade" id="add-modal" tabindex="-1" role="dialog" aria-labelledby="add-modallabel"> 
	<div class="modal-dialog" role="document"> 
		<div class="modal-content"> 
			<form class="form-horizontal" id="add-form" action="?c=solc&a=ges2&id=4&add" method="post"> 
				...
				<div class="modal-body"> 
					...
					<div class="form-group"> 
						<label for="nivel" class="col-sm-3 control-label">Seleccione Nivel :</label> 
						<div class="col-sm-9"> 
							<select class="form-control" id="nivel" name="nivel" placeholder="Nivel" required>
