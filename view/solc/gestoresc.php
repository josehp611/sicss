...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<h3>Accesos para <b><?php echo $row[0]; ?></b></h3>
			<div class="panel panel-default panel-table">
				<div class="panel-heading">
                	<div class="row">
                  		<div class="col col-xs-6">
                    		<h3 class="panel-title"><a class="btn btn-default" href="?c=solc&a=ges&id=4">Volver al listado de usuarios</a></h3>
                  		</div>
                  		<div class="col col-xs-6 text-right">
                    		<button type="button" id="btnadd" name="btnadd" class="btn btn-sm btn-primary btn-create" data-toggle="modal" data-target="#add-modal">Nueva gestion</button>
                  		</div>
                	</div>
              	</div>
				<div class="panel-body">
					<table id="gestoresTabla" name="gestoresTabla" class="table table-striped table-bordered table-list">
						...
						<tbody>
								...
								<tr>
									<td align="center"> 
										<a href="?c=solc&a=gesc&id=4&usr=<?php echo $_GET['usr']; ?>&cc=<?php echo $gestor['id_cc']; ?>&del" class="btn btn-danger"><em class="fa fa-trash"></em></a>
									</td>
									<td><?php echo $gestor['emp_nombre']; ?></td>
									<td><?php echo $gestor['cc_descripcion']; ?></td>
								</tr>
								<?php } }?>
						</tbody>
					</table>
...
<div class="modal fade" id="add-modal" tabindex="-1" role="dialog" aria-labelledby="add-modallabel"> 
	<div class="modal-dialog" role="document"> 
		<div class="modal-content"> 
			<form class="form-horizontal" id="add-form" action="?c=solc&a=gesc&id=4&usr=<?php echo $_GET['usr']; ?>&add" method="post"> 
				...
				<div class="modal-body"> 
					<div class="form-group"> 
						<label for="usuario" class="col-sm-3 control-label">Seleccione centro de costo :</label> 
						<div class="col-sm-9"> 
							<select class="form-control" id="usuario" name="usuario" placeholder="Usuario" required>
							<?php 
							foreach ($ccs as $centro){
								echo '<option value="'.$centro['id_cc'].'">'.$centro['emp_nombre'].' - '.$centro['cc_descripcion'].'</option>';
							}
							?>
							</select> 
						</div> 
