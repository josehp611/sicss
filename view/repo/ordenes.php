...
<h4 class="text-blue">Listado de Ordenes de Compra por Requisicion</h4>
<form class="form-horizontal" role="form" id="frmVer"  method="post" action="?c=repo&a=orden&id=7&page=1">
		 ...
		 <table class="table table-bordered table-condensed">
			...
			<?php } ?>
		  	<?php foreach($solcs as $solc){  ?>
		  		<?php if(isset($solc['predreq_numero_oc'])) { ?>
		  			<tr>
		  				<td><?php echo $solc['predreq_numero_oc']; ?></td>
		  				<td><?php echo $solc['predreq_fecha_oc']; ?></td>
		  				<td><?php echo $solc['predreq_hora_oc']; ?></td>
		  				<td><?php echo $solc['predreq_usuario_oc']; ?></td>
		  				<td>
			  				<?php echo $solc['nestado']; ?>
			  				<div class="btn-group btn-group-xs pull-right" role="group" aria-label="...">
			  				<a href="#myModal<?php echo $solc['predreq_numero_oc']; ?>" role="button" class="btn btn-default" data-toggle="modal">
			  					<i class="glyphicon glyphicon-list"></i> VER
			  				</a>
			  				<?php 
			  				//if ($permisos[0]['acc_xls'] == '1') { ?>
	          					<a class="btn btn-default" href="json.php?c=req&a=ocpre_gpdf&id=6&poc=<?php echo $solc['predreq_numero_oc']; ?>&p=<?php echo $solc['id_proveedor']; ?>&cia=<?php echo $solc['id_empresa']; ?>&r=1">
					...
					<div id="myModal<?php echo $solc['predreq_numero_oc']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								<div class="modal-header">
									<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
									<h3 id="myModalLabel">Detalle para Orden <?php echo $solc['predreq_numero_oc']; ?></h3>
								</div>
								<div class="modal-body">
									...
									<div class="row">
										<div class="col-md-12">
											...
											<div class="col-md-4"><?php echo $det['predreq_descripcion']; ?></div>
											<div class="col-md-4"><?php echo $det['predreq_cantidad_aut']; ?></div>
										</div>
									</div>
									<?php } ?>
								</div>
       ...
       <nav>
			<ul class="pagination">
				...
				<li class="<?php if($page == 1) echo 'disabled'; ?>">
					<a aria-label="Previous" href="?c=repo&a=orden&id=7&page=<?php echo ($page-1); ?>">
				...
				?>
					<li class="<?php if($page == $i) echo 'active'; ?>">
						<a href="?c=repo&a=orden&id=7&page=<?php echo $i; ?>"><?php echo $i; ?></a>
					</li>
				<?php
				}
				?>
				...
				<li class="<?php if($page == $totalPag) echo 'disabled'; ?>">
					<a aria-label="Next" href="?c=repo&a=orden&id=7&page=<?php echo ($page+1); ?>">
