...
<h4 class="text-blue">Listado de Requisiciones</h4>
<form class="form-horizontal" role="form" id="frmVer"  method="post" action="?c=repo&a=req&id=7&page=1">
		...
		<table class="table table-bordered table-condensed">
			...
			<?php } ?>
		  	<?php foreach($reqs as $req){  ?>
		    	...
		    	?>
  				<tr>
		  			<td><?php echo $req['prehreq_numero_req']; ?></td>
	  				<td><?php echo $req['prehreq_fecha']; ?></td>
	  				<td><?php echo $req['prehreq_hora']; ?></td>
	  				<td><?php echo $req['prehreq_usuario']; ?></td>
	  				<td>
		  				<?php echo $req['nestado']; ?>
		  				<i class="pull-right glyphicon glyphicon-list"></i>&nbsp;&nbsp;&nbsp;
		  				<a href="#myModal<?php echo $req['id_prehreq']; ?>" role="button" class="pull-right" data-toggle="modal">VER</a>
				...
				<div id="myModal<?php echo $req['id_prehreq']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
					<div class="modal-dialog">
						<div class="modal-content">
							<div class="modal-header">
								<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
								<h3 id="myModalLabel">Detalle para requisicion <?php echo $req['prehreq_numero_req']; ?></h3>
							</div>
								...
								<?php foreach($req['Det'] as $det) { ?>
									<div class="row">
										<div class="col-md-12">
											...
											<div class="col-md-4"><?php echo $det['predreq_cantidad']; ?></div>
										</div>
									</div>
								<?php } ?>
							</div>
       ...
       <nav>
			<ul class="pagination">
				...
				<li class="<?php if($page == 1) echo 'disabled'; ?>">
					<a aria-label="Previous" href="?c=repo&a=req&id=7&page=<?php echo ($page-1); ?>">
				...
				?>
					<li class="<?php if($page == $i) echo 'active'; ?>">
						<a href="?c=repo&a=req&id=7&page=<?php echo $i; ?>"><?php echo $i; ?></a>
					</li>
				<?php
				}
				?>
				...
				<li class="<?php if($page == $totalPag) echo 'disabled'; ?>">
					<a aria-label="Next" href="?c=repo&a=req&id=7&page=<?php echo ($page+1); ?>">
