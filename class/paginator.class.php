...
class Paginator{
	...
	function paginate() {
		$this->return = '<div class="pagination pagination-right" style="margin-top:0;"><ul>';
		if($_GET['ipp'] == 'All'){
		...
		if($this->num_pages > 10) {
			...
			for($i=1;$i<=$this->num_pages;$i++)	{
				$this->return .= ($i == $this->current_page) ? '<li class="active"><a href="#">'.$i.'</a></li>':'<li><a href="?c=req&a=emisor&id=6&page='.$i.'">'.$i.'</a></li>';
			}
